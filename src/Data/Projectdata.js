...
export const projectData = [
  {
    name: "Job Portal",
    image: job,
    description: "A comprehensive platform built with MVC architecture, Node.js, and Express.js, designed to streamline the job application process. It enhances connections between job seekers and employers, ensuring a seamless experience.",
    github: "https://github.com/manichandra95151/Job-Portal",
    liveLink: "https://job-portal-5cx3.onrender.com/",
  },
  {
    name: "Postaway",
    image: postman,
    description: "A robust RESTful API developed for social media interactions, featuring user authentication, post and comment management. Thoroughly tested with Postman, it supports modularity for maintainability and scalability.",
